...
final class RuleTwoCardTest extends TestCase
{
    public function testGetHand(): void
    {
        ...
        $this->assertSame(['hand_name' => 'high card', 'hand_rank' => 1, 'card_rank_1' => 2,  'card_rank_2' => 13], $rule->getHand([new PokerCard('C3'), new PokerCard('DA')]));
        ...
        $this->assertSame(['hand_name' => 'straight',  'hand_rank' => 3, 'card_rank_1' => 12, 'card_rank_2' => 13], $rule->getHand([new PokerCard('CA'), new PokerCard('DK')]));
    }
